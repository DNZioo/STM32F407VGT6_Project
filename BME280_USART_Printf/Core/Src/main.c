...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, PIN_CLK_TIM1637_Pin|PIN_DIO_TM1637_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PIN_CLK_TIM1637_Pin PIN_DIO_TM1637_Pin */
  GPIO_InitStruct.Pin = PIN_CLK_TIM1637_Pin|PIN_DIO_TM1637_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
